    ...
    public class AdminDAL
    {
        ...
        public string addCSMResponseType(viewCSMResponseType viewRT)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    lkup_CSMResponseType newRT = new lkup_CSMResponseType();
                    newRT.ID = 0;
                    newRT.Text = viewRT.Text;
                    newRT.Active = viewRT.Active;
                    newRT.UpdatedBy = (long)viewRT.UpdatedBy;
                    context.lkup_CSMResponseType.Add(newRT);
                    context.SaveChanges();
        ...
        public string deleteCSMResponseType(int deleteID, int userID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.lkup_CSMResponseType.Remove(deleteCSMResponseType);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public string addStatus(viewStatus status)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    lkup_Status newStatus = new lkup_Status();
                    newStatus.ID = status.ID;
                    newStatus.Text = status.Text;
                    newStatus.Active = status.Active;
                    newStatus.Color = status.Color;
                    newStatus.DisplayInChapterSummary = status.DisplayInChapterSummary;
                    newStatus.UpdatedBy = status.UpdatedBy;
                    context.lkup_Status.Add(newStatus);
                    context.SaveChanges();
                    result = "OK";
                }
        ...
        public string deleteStatus(int statusID, int userID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.lkup_Status.Remove(deleteStatus);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public string addCSMType(viewCSMType csmType)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    lkup_CSMType newCSMType = new lkup_CSMType();
                    newCSMType.ID = csmType.ID;
                    newCSMType.Text = csmType.Text;
                    newCSMType.Active = csmType.Active;
                    newCSMType.UpdatedBy = csmType.UpdatedBy;
                    context.lkup_CSMType.Add(newCSMType);
                    context.SaveChanges();
                    result = "OK";
                }
        ...
        public string deleteCSMType(int csmTypeID, int userID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.lkup_CSMType.Remove(deleteCSMType);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public string addSection(viewSection vSection)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    lkup_Sections newSection = new lkup_Sections();
                    newSection.ID = 0;
                    newSection.Text = vSection.Text;
                    newSection.Abbreviation = vSection.Abbreviation;
                    newSection.Active = vSection.Active;
                    newSection.UpdatedBy = vSection.UpdatedBy;
                    context.lkup_Sections.Add(newSection);
                    context.SaveChanges();
                    result = "OK";
                }
        ...
        public string deleteSection(int deleteID, int userID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.lkup_Sections.Remove(deleteSection);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                ...
                else
                {
                    var entityObj2 = context.CustomerServiceMessage_Sections
                        .FirstOrDefault((s) => s.fk_SectionID == objID);
                    if (entityObj2 != null)
                    {
                        usedInProject = true;
                    }
        ...
        public string deleteTestStepByID(int deleteID, int userID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.TestSteps.Remove(deleteTestStep);
                    context.SaveChanges();
                    ...
                    {
                        context.TestStep_BusinessRules.Remove(testStepRelationship);
                    }
                    context.SaveChanges();
                    result = "OK";
        ...
        public string addNewTestStep(viewTestStep ts)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    newTestStep.ID = 0;
                    newTestStep.Text = ts.Name;
                    newTestStep.UpdatedBy = (long)ts.UpdatedBy;
                    newTestStep.Active = ts.Active;
                    context.TestSteps.Add(newTestStep);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public string deleteDocumentType(int deleteID, int userID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.lkup_DocumentType.Remove(deleteDocType);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public string addDocumentType(viewDocumentType docType)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    lkup_DocumentType newDocType = new lkup_DocumentType();
                    newDocType.ID = docType.ID;
                    newDocType.Text = docType.Text;
                    newDocType.Active = docType.Active;
                    newDocType.IncludeBRCSMSummaryTable = docType.IncludeBRCSMChapterSummary;
                    newDocType.UpdatedBy = docType.UpdatedBy;
                    context.lkup_DocumentType.Add(newDocType);
                    context.SaveChanges();
                    result = "OK";
                }
        ...
        public string deleteChapterType(int deleteID, int userID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.lkup_ChapterType.Remove(deleteChapterType);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public string addChapterType(viewChapterType chapterType)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    lkup_ChapterType newChapterType = new lkup_ChapterType();
                    newChapterType.ID = chapterType.ID;
                    newChapterType.Text = chapterType.Text;
                    newChapterType.Active = chapterType.Active;
                    newChapterType.UpdatedBy = chapterType.UpdatedBy;
                    context.lkup_ChapterType.Add(newChapterType);
                    context.SaveChanges();
        ...
        public string addDefectStatus(viewDefectStatus defectStatus)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    lkup_DefectStatus newDefectStatus = new lkup_DefectStatus();
                    newDefectStatus.ID = defectStatus.ID;
                    newDefectStatus.Text = defectStatus.Text;
                    newDefectStatus.Active = defectStatus.Active;
                    newDefectStatus.UpdatedBy = defectStatus.UpdatedBy;
                    context.lkup_DefectStatus.Add(newDefectStatus);
                    context.SaveChanges();
                    result = "OK";
                }
        ...
        public string deleteDefectStatus(int deleteID, int userID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.lkup_DefectStatus.Remove(deleteDefectStatus);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    var deleteDefectType = context.lkup_DefectType
                               .First((docType) => docType.ID == deleteID);
                    context.lkup_DefectType.Remove(deleteDefectType);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public string addDefectType(viewDefectType dt)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    lkup_DefectType newDefectType = new lkup_DefectType();
                    newDefectType.ID = dt.ID;
                    newDefectType.Text = dt.Text;
                    newDefectType.Active = dt.Active;
                    newDefectType.UpdatedBy = dt.UpdatedBy;
                    context.lkup_DefectType.Add(newDefectType);
                    context.SaveChanges();
                    result = "OK";
                }
        ...
        public string deleteDefectPriority(int deleteID, int userID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.lkup_DefectPriority.Remove(deleteDefectPriority);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public string addDefectPriority(viewDefectPriority dp)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    lkup_DefectPriority newDefectPriority = new lkup_DefectPriority();
                    newDefectPriority.ID = dp.ID;
                    newDefectPriority.Text = dp.Text;
                    newDefectPriority.Active = dp.Active;
                    newDefectPriority.UpdatedBy = dp.UpdatedBy;
                    newDefectPriority.Importance = dp.Importance;
                    context.lkup_DefectPriority.Add(newDefectPriority);
                    context.SaveChanges();
                    result = "OK";
                }
