...
{    
    ...
    public class TestCasesDAL
    {
        ...
        public List<TestCas> getAllTestCases()
        {
            using (var context = palinoiaDAL.getContextForProject())
            {
                List<TestCas> testCasesList = new List<TestCas>();
                try
                {
                    var testCases = context.TestCases
                                    .OrderBy((tc) => tc.Name);
                    testCasesList = testCases.ToList<TestCas>();
        ...
        public TestCas getTestCaseByID(int testCaseID)
        {
            using (var context = palinoiaDAL.getContextForProject())
            {
        ...
        public string addNewTestCase(viewTestCase tc)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    TestCas newTestCase = new TestCas();
                    newTestCase.ID = 0;
                    newTestCase.Name = tc.Name;
                    newTestCase.Active = tc.Active;
                    newTestCase.UpdatedBy = tc.UpdatedBy;
                    newTestCase.fk_TestStatusID = (long)Enums.testStatusEnums.TestStatus.Untested;
        ...
        public string deleteTestCase(int deleteID, int userID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.TestCases.Remove(deleteTestCase);
                    context.SaveChanges();
                    ...
                    {
                        context.TestCase_TestSteps.Remove(testStepRelationship);
                    }
                    context.SaveChanges();
                    result = "OK";
                }
        ...
        public string updateTestCase(viewTestCase vtestCase)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    TestCas testCase = context.TestCases
                    ...
                    result = this.deleteBusinessRuleRelationshipsForTestCaseID(testCaseID);
                     if(result.Equals("OK")) {
                        foreach(var rule in brList) {
                            TestCase_BusinessRules relationship = new TestCase_BusinessRules();
                            relationship.ID = 0;
                            relationship.fk_TestCaseID = (long)testCaseID;
                            relationship.fk_BusinessRuleID = (long)rule.ID;
                            context.TestCase_BusinessRules.Add(relationship);
                            context.SaveChanges();
                        }
                    }
                }
        ...
        public string deleteBusinessRuleRelationshipsForTestCaseID(int testCaseID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    {
                        context.TestCase_BusinessRules.Remove(relationship);
                    }
                    context.SaveChanges();
                    result = "OK";
                }
        ...
        public string removeTestStepTestCaseRelationship(int testStepID, int testCaseID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    {
                        context.TestCase_TestSteps.Remove(testCaseRelationship);
                    }
                    context.SaveChanges();
                    result = "OK";
                }
        ...
        private void addTestCaseTestStepRelationship(int testCaseID, viewTestStep testStep)
        {
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    TestCase_TestSteps newRelationship = new TestCase_TestSteps();
                    newRelationship.ID = 0;
                    newRelationship.SeqNum = (long)testStep.SeqNum;
                    newRelationship.fk_TestCaseID = (long)testCaseID;
                    newRelationship.fk_TestStepID = (long)testStep.ID;
                    newRelationship.Notes = testStep.Notes;
                    context.TestCase_TestSteps.Add(newRelationship);
                    context.SaveChanges();
                }
                catch (Exception ex)
                {
        ...
        public string addTestStep_BusinessRuleRelationship(int testStepID, int businessRuleID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    TestStep_BusinessRules newRelationship = new TestStep_BusinessRules();
                    newRelationship.ID = 0;
                    newRelationship.fk_TestStepID = (long)testStepID;
                    newRelationship.fk_BusinessRuleID = (long)businessRuleID;
                    context.TestStep_BusinessRules.Add(newRelationship);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public List<TestCas> getPreConditionsForTestCase(int testCaseID)
        {
            using (var context = palinoiaDAL.getContextForProject())
            {
                List<TestCas> pctcList = new List<TestCas>();
                try
                {
        ...
        private void addPreConditionTestCaseRelationship(int tcID, int pctcID, int seqnum)
        {
            using (var context = palinoiaDAL.getContextForProject())
            {
                TestCase_PreConditions tcpc = new TestCase_PreConditions();
                tcpc.ID = 0;
                tcpc.fk_TestCaseID = (long)tcID;
                tcpc.PreConditionTestCaseID = (long)pctcID;
                tcpc.SeqNum = (long)seqnum;
                context.TestCase_PreConditions.Add(tcpc);
                context.SaveChanges();
        ...
        public string removeAllPreConditionTestCases(int tcID)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    ...
                    {
                        context.TestCase_PreConditions.Remove(pctc);
                        context.SaveChanges();
                    }
                    result = "OK";
                }
        ...
        public string saveTestResult(viewTestResult tr)
        {
            ...
            using (var context = palinoiaDAL.getContextForProject())
            {
                try
                {
                    TestResult entityTR = new TestResult();
                    entityTR.ID = 0;
                    entityTR.fk_TestCaseID = (long)tr.CurrentTestCaseID;
                    entityTR.fk_TestStepID = (long)tr.TestStepID;
                    entityTR.fk_TestStatusID = (long)tr.TestStatusID;
                    entityTR.UserID = (long)tr.UserID;
                    entityTR.TestDate = tr.TestDate;
                    entityTR.Notes = tr.Notes;
                    entityTR.failedBusinessRuleID = tr.FailedBusinessRuleID;
                    context.TestResults.Add(entityTR);
                    context.SaveChanges();
