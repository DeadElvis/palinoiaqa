...
{    
    ...
    public partial class adminProject : basePalinoiaPage
    {
                ...
                foreach (DataControlFieldCell cell in e.Row.Cells)
                {
                    ...
                    foreach (Control control in cell.Controls)
                    {
                        ...
                        if (button != null && button.CommandName == "Delete")
                        {
                            ...
                            button.OnClientClick = "return confirm('Are you sure you want to delete this project?');";
                            if (disableDelete)
                            {
        ...
        public void populateProjectsGrid()
        {
            ...
            //limit projects for demo user to just the Palinoia example project
            if (bll.getUserByID(userID).Email.Equals("demouser@palinoiaqa.com"))
            {
                foreach (var project in projectList)
                {
                    if (project.Name.Equals("Palinoia"))
                    {
                        var demoList = new List<viewProject>();
                        demoList.Add(project);
                        grdProjects.DataSource = demoList;
                        grdProjects.DataBind();
                        break;
                    }
                }
            ...
            {
                //regular user, load all projects
