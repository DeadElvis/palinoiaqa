    ...
    public class DefectsDAL
    {
        ...
        public int addNewDefect(viewDefect defect, int userID)
        {
            ...
            using (var context = appDAL.getContextForProject())
            {
                try
                {
                    Defect entityNewDefect = new Defect();
                    entityNewDefect.ID = (long)defect.ID;
                    entityNewDefect.fk_DefectPriorityID = (long)defect.DefectPriorityID;
                    entityNewDefect.fk_DefectStatusID = (long)defect.DefectStatusID;
                    entityNewDefect.fk_DefectTypeID = (long)defect.DefectTypeID;
                    entityNewDefect.DefectName = defect.Name;
                    entityNewDefect.Description = defect.Description;
                    entityNewDefect.DateCreated = Convert.ToDateTime(defect.DateCreated);
                    entityNewDefect.Closed = false;
                    entityNewDefect.UpdatedBy = (long)userID;
                                                                 
                    entityNewDefect.OwnerID = (long)defect.OwnerID;
                    context.Defects.Add(entityNewDefect);
                    context.SaveChanges();
        ...
        public string deleteDefectByID(int deleteID, int userID)
        {
            ...
            using (var context = appDAL.getContextForProject())
            {
                try
                {
                    ...
                    context.Defects.Remove(deleteDefect);
                    context.SaveChanges();
        ...
        public string addComment(viewComment comment)
        {
            ...
            using (var context = appDAL.getContextForProject())
            {
                try
                {
                    Defect_Comments entityComment = new Defect_Comments();
                    entityComment.ID = comment.ID;
                    entityComment.fk_DefectID = comment.DefectID;
                    entityComment.UserID = comment.UserID;
                    entityComment.DateCreated = comment.DateCreated;
                    entityComment.Text = comment.Text;
                    context.Defect_Comments.Add(entityComment);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public string deleteCommentsForDefect(int defectID)
        {
            ...
            using (var context = appDAL.getContextForProject())
            {
                try
                {
                    ...
                    {
                        context.Defect_Comments.Remove(record);
                    }
                    context.SaveChanges();
                    result = "OK";
                }
        ...
        public string createDefectBusinessRuleRelationship(int businessRuleID, int defectID, int userID)
        {
            ...
            using (var context = appDAL.getContextForProject())
            {
                try
                {
                    var entityDefectBusinessRuleRecord = new Defect_BusinessRules();
                    entityDefectBusinessRuleRecord.fk_BusinessRuleID = businessRuleID;
                    entityDefectBusinessRuleRecord.fk_DefectID = defectID;
                    context.Defect_BusinessRules.Add(entityDefectBusinessRuleRecord);
                    context.SaveChanges();
                    result = "OK";
                }
                catch (Exception ex)
        ...
        public string deleteDefectBusinessRuleRelationshipByBRID(int businessRuleID, int userID)
        {
            ...
            using (var context = appDAL.getContextForProject())
            {
                try
                {
                    ...
                    foreach (var record in deleteRecords)
                    {
                        context.Defect_BusinessRules.Remove(record);
                    }
                    context.SaveChanges();
                }
                catch (Exception ex)
