...
{    
    ...
    public class basePalinoiaPage : System.Web.UI.Page
    {
        ...
        //    sb.AppendLine("<script src=\"../../Scripts/jquery-ui-1.11.4.min.js\" type=\"text/javascript\"></script>");
        ...
        public void sendMessageToClient(string html)
        {
            ...
            {
                ClientScript.RegisterClientScriptBlock(typeof(Page), "SymbolError", "<script type='text/javascript'>alert('" + html + "');</script>");
            }
            ////clean Message
        ...
        public void sendHTMLMessageToClient(string html)
        {
            ...
            if (!cs.IsClientScriptBlockRegistered(csType, csName))
            {
                //ClientScript.RegisterClientScriptBlock(typeof(Page), "SymbolError", "<script type='text/javascript'>alert('KLH');</script>");
                ClientScript.RegisterClientScriptBlock(typeof(Page), "SymbolError", "<script type='text/javascript'>alert('" + html + "');</script>");
            }
        }
