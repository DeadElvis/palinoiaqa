...
function initializeControls() {
    ...
    $(".calDateCompleted").change(function (e) { $("[id$='hdnDateCompleted']").val($(".calDateCompleted").val()); alert("dateCompleted change: " + $(".calDateCompleted").val()); });
    $(".calDateCreated").change(function (e) { $("[id$='hdnDateCreated']").val($("#txtCreated").val()); alert("dateCreated change: " + $("#txtCreated").val()); });
    //initialize comments
...
function validateDefect() {
    ...
    if($('input[id$=txtName]').val().length == 0) {
        ...
        alert("Owner is a required field.");
        valid = false;
    }
    else if (priorityDDL.val() == "0") {
        alert("Priority is a required field.");
        valid = false;
    }
